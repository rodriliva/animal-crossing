...
document.getElementById("randomVillager").innerHTML =(`you would be a ${randomGender} ${randomColor} <strong>${randomSpecies}</strong>, with a ${randomPersonalities} personality and a ${randomStyle} style!`)
}
